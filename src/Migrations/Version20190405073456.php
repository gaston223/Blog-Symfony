 ...
 */
final class Version20190405073456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD is_published TINYINT(1) NOT NULL, ADD nb_views INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP is_published, DROP nb_views');
    }
}
